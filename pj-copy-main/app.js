...
app.config(function($routeProvider) {
   ...
   app.controller(
    ...
    app.controller(
        'NewController', function($scope, $routeParams) {
         routers($routeParams.keyword === undefined ? '' : $routeParams.keyword);
    });


    app.controller(
        'UsedController', function($scope, $routeParams) {
            routers($routeParams.keyword === undefined ? '' : $routeParams.keyword);
    });


    app.controller(
        'BrandController',  function($scope, $routeParams) {
            routers($routeParams.keyword === undefined ? '' : $routeParams.keyword);
    });
    ...
    app.controller(
       'BlogController', function($scope) {
            BlogController()
    });

    app.controller(
       'GalleryController', function($scope) {
        GalleryController()
    });
    ...
    function hienDT(thuonghiendachon = [], giabandachon = []) {
        ...
        for (var i = 0; i < arrDT.length; i++) {
            ...
            if (giabandachon.length > 0) {
                if (gia < 200000 && giabandachon.includes("1") == false)
                    continue
                if (gia >= 200000 && gia < 300000 && giabandachon.includes("2") == false)
                    continue
                if (gia >= 300000 && gia < 400000 && giabandachon.includes("3") == false)
                    continue
                if (gia >= 400000 && gia < 500000 && giabandachon.includes("4") == false)
                    continue
                if (gia > 500000 && giabandachon.includes("5") == false)
                    continue
            }
            list1.innerHTML +=
    ...
    function hienDTs(thuonghiendachons = [], giabandachons = []) {
        ...
        for (var i = 0; i < arrDT.length; i++) {
            ...
            if (giabandachons.length > 0) {
                if (gias < 200000 && giabandachons.includes("1") == false)
                    continue
                if (gias >= 200000 && gias < 300000 && giabandachons.includes("2") == false)
                    continue
                if (gias >= 300000 && gias < 400000 && giabandachons.includes("3") == false)
                    continue
                if (gias >= 400000 && gias < 500000 && giabandachons.includes("4") == false)
                    continue
                if (gias > 500000 && giabandachons.includes("5") == false)
                    continue
            }
            lists.innerHTML +=
                `
...
var arrDT_origin = [
    ...
    },
    {
        tenDT: "G63",
        gia: 520000,
        hinh: "https://img1.oto.com.vn/2021/11/05/OpzfnMD2/dai-dien-6934.jpg",
        imageModal1:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeZDgDMKX7D-d8lNCpEkmDF-a_lVH2KJLYH1WJRODU2l2gUIDDxmSUpDFYNHPkBtBmGVs&usqp=CAU',
        imageModal2:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQybciX-AtfEPeQbaWg3u8KSRt5pggPkBsft-oHA7Z63PIE3fDmFcf9WiMTHCxYQfLi3TE&usqp=CAU',
        thuonghieu: "MERC",
        KieuDang : 'SUV',
        DongCo : 'V8 3.9l',
        HopSo :'AT',
...
$("#MyInput").on("keypress", function(e) {
    ...
    if (e.keyCode == 13) {
        ...
        arr_url[arr_url.length - 1] = 'new-car';
